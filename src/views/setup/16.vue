<!-- User will be automatically brought to this screen by a text file present on SD 4 which informs arctica to redirect the user to this page (state variable setup2)-->
<template>
