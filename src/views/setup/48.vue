<template>
    ...
    <div v-else class="page">
        <header>
        <h1>DVD/M-DISC 7 Backup</h1>
        <h2>Please remove CD 7 and insert DVD/M-DISC 7.</h2>
    </header>
    <div class="form_container">
        <form>
            <div class="checkbox_container">
                <input type="checkbox" v-model="checkbox" name="checkbox">
                <label for="checkbox">I have inserted DVD/M-DISC 7.</label>
            </div>
        </form>
        ...
        acknowledge(){
            ...
            invoke('make_backup', {number: "7"}).then((res) => {
                ...
                this.$router.push({ name: 'Setup49a' })
                    ...
                    store.commit('setErrorMessage', `Error making backup iso Error code: Setup48-1 Response: ${e}`)
