...
<h1>Package 7 is now complete.</h1>
 <h2>Please remove DVD 7 and SD card 7.</h2>
 <h2>Place SD card 7, and backups CD 7 and DVD 7 into Envelope 7.</h2> 
    ...
    mounted(){
        ...
        invoke('async_write', {name: 'setupStep', value: this.setupStep}).then(() => {
            ...
            .catch((e) => {
                ...
                store.commit('setErrorMessage', 'Error with async write Error code Setup49a-1')
