...
<div class="page">
    ...
    <div class="form_container">
        ...
        <div class="btn_container"> 
            <button v-if="this.currentSD == 3 && checkbox && this.setupCD == false" @click="acknowledge()" class="btn">Proceed</Button>
...
export default {
  name: 'Setup31b',
    methods: {
        acknowledge(){
            console.log('user ack, moving info from SD 3 to CD 3')
            this.$router.push({ name: 'Setup32' })
            //fully backup SD 3 here
        },
        warn(){
