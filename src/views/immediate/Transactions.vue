...
<div class="page">
    <NavImmediate />
      <div class="dashboard">
        ...
        <div @click="transactionDetail(transaction.info.txid)" v-for="transaction in this.immediateTransactions" :key="transaction.info.blockhash" class="transaction_container">
