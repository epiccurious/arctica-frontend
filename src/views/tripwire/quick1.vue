...
<div class="page">
<header>
    <h1>Are you sure you want to perform a quick withdrawal?</h1>
    <h2>This is not the reccomended way to access your funds.</h2>
    <h2>Please confirm before proceeding.</h2>
 </header>
