...
<div class="page">
  <nav id="nav">Debug Nav bar:
    ...
    <router-link :to="{ name: 'sign1of2' }">Sign(1of2)</router-link>
    <router-link :to="{ name: '1of2success' }">1of2-success</router-link>
    <router-link :to="{ name: 'sign2of2' }">Sign(2of2)</router-link>
    <router-link :to="{ name: '2of2success' }">2of2-success</router-link>
    ...
    <router-link :to="{ name: 'Setup14' }">Setup-14</router-link>
    <router-link :to="{ name: 'Setup15' }">Setup-15</router-link>
